...
#
# Created: Fri Nov 18 14:37:27 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.resourceList = SimpleResourceList(self.leftWidget)
        ...
        self.urlLabel = ResourceLabel(self.widget_2)
        font = QtGui.QFont()
        font.setItalic(True)
        ...
        self.labelEdit.setStyleSheet("p")
        ...
        self.tableView = TaggerTableView(self.widget_4)
        self.tableView.setObjectName("tableView")
        self.tableView.verticalHeader().setVisible(False)
        self.verticalLayout_2.addWidget(self.tableView)
        self.tagCloudView = TagCloudView(self.widget_4)
        self.tagCloudView.setMinimumSize(QtCore.QSize(0, 80))
        self.tagCloudView.setMaximumSize(QtCore.QSize(16777215, 80))
        ...
        self.verticalLayout_2.addWidget(self.tagCloudView)
...
from dedalus.ui.ResourceLabel import ResourceLabel
from dedalus.ui.SimpleResourceList import SimpleResourceList
from dedalus.ui.tagger.TaggerTableView import TaggerTableView
